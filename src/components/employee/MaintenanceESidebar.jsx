...
import { HammerIcon, PawPrint, PencilRuler } from "lucide-react";

export default function MaintenanceESidebar() {
	...
	const navLinks = [
		{
			href: "/employee/maintenance/exhibit",
			icon: <PawPrint className="h-6 w-6 mr-1" />,
			name: "Exhibits",
		},
		{
			href: "/employee/maintenance/maintenance_report",
			icon: <HammerIcon className="h-6 w-6 mr-1" />,
			name: "Maintenance Reports",
		},
		{
			href: "/employee/maintenance/search",
