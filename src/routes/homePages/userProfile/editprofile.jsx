...
export default function EditProfile() {
  ...
  const [middleInitial, setMiddleInitial] = useState(userData.data.middle_initial || "");
...
const handleSave = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/public/profile/${visitorId}`, {
        method: "PUT",
        headers: {
