  ...
  const usersData = [
      ...
      visits: [
        {
          ...
          activities: ["Lion Show", "Reptile House"],
        },
        {
          date: "August 22, 2023",
          activities: ["Bird Pavilion", "Elephant Walk"],
        },
        { date: "July 12, 2023", activities: ["Penguin Parade", "Aquarium"] },
      ],
      currentTickets: 3,
    ...
    },
    {
      ...
      visits: [
        {
          date: "October 1, 2023",
          activities: ["Elephant Walk", "Monkey Forest"],
        },
        {
          date: "September 10, 2023",
          activities: ["Reptile House", "Giraffe Feeding"],
        },
      ],
      currentTickets: 2,
      balance: "$30.00",
      ...
      <div className="bg-white w-full max-w-4xl p-10 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-100 p-6 rounded-lg shadow-sm">
            ...
            <p>
              <strong>Current Tickets:</strong> {userData.currentTickets}
            </p>
            <p>
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-bold text-green-600 mb-4">Visits</h3>
            <p>
              <strong>Favorite Animal:</strong> {userData.favoriteAnimal}
            </p>
            <ul className="mt-2">
              {userData.visits.map((visit, index) => (
                <li key={index} className="text-gray-700">
