...
// 	console.log(user.data.visitor_id); // Ensure this logs the correct visitor ID
  
// 	const url = `/public/profile/${user.data.visitor_id}`;
...
// 		// Update local state and localStorage correctly
// 		const updatedUser = {
// 		  ...user,
// 		  data: {
// 			...user.data,
...
// 	  } else {
// 		console.error("Failed to update membership:", responseData);
// 	  }
// 	} catch (error) {
