export default function Hours() {
	return (
		<div className="min-h-screen bg-gray-100 p-8">
			<h1 className="text-4xl font-bold text-center mb-8">Hours of Operation</h1>
				...
				<table className="min-w-full border-collapse">
					<thead>
						<tr>
							...
							<th className="border-b-2 border-gray-300 text-left p-4">Hours</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td className="border-b border-gray-200 p-4">Monday</td>
							<td className="border-b border-gray-200 p-4">10:00 AM - 5:00 PM</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td className="border-b border-gray-200 p-4">10:00 AM - 6:00 PM</td>
						</tr>
						<tr>
							<td className="border-b border-gray-200 p-4">Saturday</td>
							<td className="border-b border-gray-200 p-4">9:00 AM - 6:00 PM</td>
						</tr>
						<tr>
