		...
		<div className="min-h-screen bg-gray-100 p-8">
			...
			<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
				{eventsData.map((event, index) => {
					...
					const startTime = new Date(`1970-01-01T${event.start_time}Z`).toLocaleTimeString('en-US', {
						hour: '2-digit',
						minute: '2-digit',
					});
					const endTime = new Date(`1970-01-01T${event.end_time}Z`).toLocaleTimeString('en-US', {
						hour: '2-digit',
						minute: '2-digit',
					});
