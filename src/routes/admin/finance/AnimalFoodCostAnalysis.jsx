...
export default function AnimalFoodCostAnalysis() {
	...
	async function fetchDataRange(e) {
		...
		const rawRes = await fetch(
			...
			}/admin/raw_cost_analysis_animal_food?start_date=${sDate}&end_date=${eDate}&animal_name=${animalName}`
		);
		...
		const analysisRes = await fetch(
			`${
				import.meta.env.VITE_API_URL
			}/admin/cost_analysis_animal_food?start_date=${sDate}&end_date=${eDate}&animal_name=${animalName}`
		);
